...
<head>
    ...
    <%--<link rel="icon" href="/trading-form/images/favicon.ico">--%>
    <link rel="stylesheet" href="/trading_platform/lib/layui-v2.5.5/css/layui.css" media="all">
    <link rel="stylesheet" href="/trading_platform/css/layuimini.css?v=2.0.4" media="all">
    <link rel="stylesheet" href="/trading_platform/css/themes/default.css" media="all">
    <link rel="stylesheet" href="/trading_platform/lib/font-awesome-4.7.0/css/font-awesome.min.css" media="all">
    <!--[if lt IE 9]>
    ...
    <script>
        ...
        /*layui.use(['jquery', 'layer', 'miniAdmin','miniTongji'], function () {
            ...
            var options = {
                ...
                iniUrl: "/trading_platform/api/init.json",    // 初始化接口，管理

                clearUrl: "/trading_platform/api/clear.json", // 缓存清理接口
